...
urlpatterns = [
  ...
  url(r'hc_recommendation/$', views.hc_recommendation_view, name='hc-recommendation'),
  url(r'hc_recommendation/update/(?P<pk>\d+)$', views.hc_recommendation_view, name='hc-recommendation-update'),
