...
class DisciplineCreateView(SuperuserRequiredMixin, SuccessMessageMixin, CreateView):
    model = Discipline
...
class SummaryApproveView(SuperuserRequiredMixin, DetailView):
...
class AttendanceAssign(SuperuserRequiredMixin, ListView):
