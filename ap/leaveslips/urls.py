...
urlpatterns = [
    ...
    url(r'(?P<classname>individual|group)/(?P<status>[LIT])/(?P<ls_id>\d+)$', views.ta_sister_actions, name='ta_sister_actions'), # L = approve from list view; I = approve from individual detail view; T = transfer without approving
