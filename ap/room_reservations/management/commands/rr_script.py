...
class Command(BaseCommand):
  ...
  def roomlist(self):
    return {"26":"MC","45":"NE3","92":"SW120","93":"NW201","94":"NE209","95":"NE210","96":"NE212","97":"NE213","98":"NE215","99":"NE216","100":"NE217","101":"NE218","102":"NE219","103":"NE220","104":"NE221","105":"NE222","106":"NE223","107":"NE224","108":"NE225","109":"SE238","110":"SE239","111":"SE240","112":"SE241","113":"SE242","114":"SE243","115":"SE244","116":"SE245","117":"NW108","119":"SW227","120":"SE131","121":"SW229","122":"SE132","124":"SE133"}
  ...
  def check_continuous(self, event1, event2):
    return int(self.get_id(event1))==int(self.get_id(event2))-1 and self.get_date(event1)==self.get_date(event2) and self.get_time(event1)==self.get_time(event2)-timedelta(0,1800) and self.get_room(event1)==self.get_room(event2) and self.get_content(event1)==self.get_content(event2)
  ...
  def check_repeat(self, event1, event2):
    return self.get_date(event1)==self.get_date(event2)-timedelta(7) and self.get_time(event1)==self.get_time(event2) and self.get_room(event1)==self.get_room(event2) and self.get_content(event1)==self.get_content(event2)
