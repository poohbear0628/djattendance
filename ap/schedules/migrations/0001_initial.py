    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(max_length=1, choices=[(b'C', b'Class'), (b'S', b'Study'), (b'R', b'Rest'), (b'M', b'Meal'), (b'H', b'House'), (b'T', b'Team'), (b'L', b'Church Meeting'), (b'*', b'Special')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trainees', models.ManyToManyField(related_name='schedules', to='accounts.Trainee', blank=True)),
            ],
        ),
        migrations.CreateModel(
            name='Class',
