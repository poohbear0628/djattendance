    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(default=b'E', max_length=1, choices=[(b'B', b'Brother'), (b'S', b'Sister'), (b'E', b'Either'), (b'X', b'Either All Brothers or All Sisters')])),
                ('workers_required', models.PositiveSmallIntegerField(default=1)),
                ('weekday', models.PositiveSmallIntegerField(default=b'7', choices=[(0, b'Monday'), (1, b'Tuesday'), (2, b'Wednesday'), (3, b'Thursday'), (4, b'Friday'), (5, b'Saturday'), (6, b"Lord's Day")])),
                ('start', models.TimeField(default=datetime.datetime(2016, 4, 8, 17, 19, 4, 34888))),
                ('end', models.TimeField(default=datetime.datetime(2016, 4, 8, 17, 19, 4, 34923))),
