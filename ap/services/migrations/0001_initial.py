    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(default=b'E', max_length=1, choices=[(b'B', b'Brother'), (b'S', b'Sister'), (b'E', b'Either'), (b'X', b'Either All Brothers or All Sisters')])),
                ('workers_required', models.PositiveSmallIntegerField(default=1)),
                ('weekday', models.CharField(default=b'5', max_length=1, choices=[(b'0', b'Monday'), (b'1', b'Tuesday'), (b'2', b'Wednesday'), (b'3', b'Thursday'), (b'4', b'Friday'), (b'5', b'Saturday'), (b'6', b"Lord's Day")])),
                ('start', models.TimeField(default=datetime.datetime(2016, 4, 7, 22, 57, 44, 644348))),
                ('end', models.TimeField(default=datetime.datetime(2016, 4, 7, 22, 57, 44, 644383))),
