$(document).ready(function(){
  ...
  function getTrainees(data) {
    ...
    for (i = 0; i < data['terms'].length; i++) {
      deferreds.push(
        $.ajax({
          url: base_url + api_base + '/workers/term/' + data['terms'][i] + '/?format=json',
    ...
    if (data['gender']) {
      deferreds.push(
        $.ajax({
          url: base_url + api_base + '/workers/gender/' + data['gender'] + '/?format=json',
          contentType: 'application/json',
          data: data,
          dataType: 'json',
          success: function(data) {
    ...
    if (data['hc']) {
      deferreds.push(
        $.ajax({
          url: base_url + api_base + '/workers/hc/?format=json',
          contentType: 'application/json',
          data: data,
          dataType: 'json',
          success: function(data) {
    ...
    for (i = 0; i < data['team_types'].length; i++) {
      deferreds.push(
        $.ajax({
          url: base_url + api_base + '/workers/teamtype/' + data['team_types'][i] + '/?format=json',
          contentType: 'application/json',
          data: data,
          dataType: 'json',
          success: function(data) {
    ...
    if (data['teams']!==null) {
      for (i = 0; i < data['teams'].length; i++) {
        ...
        deferreds.push(
          $.ajax({
            url: base_url + api_base + '/workers/team/' + data['teams'][i] + '/?format=json',
            contentType: 'application/json',
            data: data,
            dataType: 'json',
            success: function(data) {
    ...
    if (data['houses']!==null) {
      for (i = 0; i < data['houses'].length; i++) {
        ...
        deferreds.push(
          $.ajax({
            url: base_url + api_base + '/workers/house/' + data['houses'][i] + '/?format=json',
            contentType: 'application/json',
            data: data,
            dataType: 'json',
            success: function(data) {
    ...
    if (data['localities']!==null) {
      for (i = 0; i < data['localities'].length; i++) {
        ...
        deferreds.push(
          $.ajax({
            url: base_url + api_base + '/workers/locality/' + data['localities'][i] + '/?format=json',
            contentType: 'application/json',
            data: data,
            dataType: 'json',
            success: function(data) {
