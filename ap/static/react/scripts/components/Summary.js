...
import RollDetail2 from './RollDetail2'
import LeaveSlipDetail from './LeaveSlipDetail'
import LeaveSlipDetail2 from './LeaveSlipDetail2'
...
const Summary = ({...p}) => {
  ...
  return (
    <div>
      ...
      <h5>Total</h5>
        <div className="roll__table roll__table--absent row">
          <div className="col-md-4">Unexcused Absences</div>
          <div className="col-md-2">{unexcused_absences}</div>
          <div className="col-md-4">Leave-Slips</div>
