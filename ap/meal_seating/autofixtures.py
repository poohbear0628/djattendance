...
# class UserBrotherAutoFixture(AutoFixture):
...
#         'gender': "B",
#     }
# register(User, UserBrotherAutoFixture)

# class UserSisterAutoFixture(AutoFixture):
...
#         'gender': "S",
#     }
# register(User, UserSisterAutoFixture, overwrite=True)
