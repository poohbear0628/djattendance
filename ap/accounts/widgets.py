...
class TraineeSelect2MultipleInput(Select2MultipleWidget):
  def render(self, name, value, attrs=None):
    output = super(TraineeSelect2MultipleInput, self).render(name, attrs)
    print super(TraineeSelect2MultipleInput, self)
...
class EventSelect2MultipleInput(Select2MultipleWidget):
  def render(self, name, value, attrs=None):
    output = super(EventSelect2MultipleInput, self).render(name, attrs)
