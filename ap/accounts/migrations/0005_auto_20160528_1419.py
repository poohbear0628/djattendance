...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('leaveslips', '0003_auto_20160528_1419'),
        ('houses', '0002_auto_20160504_1806'),
        ('teams', '0002_team'),
        ('web_access', '0003_auto_20160528_1419'),
        ('attendance', '0003_auto_20160528_1419'),
        ('lifestudies', '0003_auto_20160528_1419'),
        ('services', '0002_auto_20160504_1806'),
        ('aputils', '0003_auto_20160528_1419'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='type',
            field=models.CharField(default=1, max_length=1, choices=[(b'T', b'Training Assistant'), (b'R', b'Regular (full-time)'), (b'S', b'Short-term (long-term)'), (b'C', b'Commuter')]),
