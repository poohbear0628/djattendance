...
urlpatterns = [
  ...
  url(r'^admin/(?P<pk>\d+)/by_preference/team_contact$', views.assign_team_contact, name='assign-team-contact'),
  url(r'^admin/(?P<pk>\d+)/by_preference/assign_destination$', views.assign_destination, name='assign-destination'),
]
