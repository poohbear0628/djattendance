...
('Exodus', 'Exo.', 'Exo(?:\.|dus)', [22, 25, 22, 31, 23, 30, 25, 32, 35, 29, 10, 51, 22, 31, 27, 36, 16, 27, 25, 26, 36, 31, 33, 18, 40, 37, 21, 43, 46, 38, 18, 35, 23, 35, 35, 38, 29, 31, 43, 38]),
...
('1 Samuel', '1 Sam.', '(?:1|I|First)(?:\s*)Sam(?:\.|uel)', [28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35, 23, 58, 30, 24, 42, 15, 23, 29, 22, 44, 25, 12, 25, 11, 31, 13]),
('2 Samuel', '2 Sam.', '(?:2|II|Second)(?:\s*)Sam(?:\.|uel)', [27, 32, 39, 12, 25, 23, 29, 18, 13, 19, 27, 31, 39, 33, 37, 23, 29, 33, 43, 26, 22, 51, 39, 25]),
('1 Kings', '1 Kings', '(?:1|I|First)(?:\s*)K(?:in)?gs', [53, 46, 28, 34, 18, 38, 51, 66, 28, 29, 43, 33, 34, 31, 34, 34, 24, 46, 21, 43, 29, 53]),
('2 Kings', '2 Kings', '(?:2|II|Second)(?:\s*)K(?:in)?gs', [18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 21, 21, 25, 29, 38, 20, 41, 37, 37, 21, 26, 20, 37, 20, 30]),
('1 Chronicles', '1 Chron.', '(?:1|I|First)(?:\s*)Chron(?:\.|icles)', [54, 55, 24, 43, 26, 81, 40, 40, 44, 14, 47, 40, 14, 17, 29, 43, 27, 17, 19, 8, 30, 19, 32, 31, 31, 32, 34, 21, 30]),
('2 Chronicles', '2 Chron.', '(?:2|II|Second)(?:\s*)Chron(?:\.|icles)', [17, 18, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16, 22, 15, 19, 14, 19, 34, 11, 37, 20, 12, 21, 27, 28, 23, 9, 27, 36, 27, 21, 33, 25, 33, 27, 23]),
...
('Psalms', 'Psa.', 'Psa(?:\.|lm(?:s)?)', [6, 12, 8, 8, 12, 10, 17, 9, 20, 18, 7, 8, 6, 7, 5, 11, 15, 50, 14, 9, 13, 31, 6, 10, 22, 12, 14, 9, 11, 12, 24, 11, 22, 22, 28, 12, 40, 22, 13, 17, 13, 11, 5, 26, 17, 11, 9, 14, 20, 23, 19, 9, 6, 7, 23, 13, 11, 11, 17, 12, 8, 12, 11, 10, 13, 20, 7, 35, 36, 5, 24, 20, 28, 23, 10, 12, 20, 72, 13, 19, 16, 8, 18, 12, 13, 17, 7, 18, 52, 17, 16, 15, 5, 23, 11, 13, 12, 9, 9, 5, 8, 28, 22, 35, 45, 48, 43, 13, 31, 7, 10, 10, 9, 8, 18, 19, 2, 29, 176, 7, 8, 9, 4, 8, 5, 6, 5, 6, 8, 8, 3, 18, 3, 3, 21, 26, 9, 8, 24, 13, 10, 7, 12, 15, 21, 10, 20, 14, 9, 6]),
('Proverbs', 'Prov.', 'Prov(?:\.|erbs)', [33, 22, 35, 27, 23, 35, 27, 36, 18, 32, 31, 28, 25, 35, 33, 33, 28, 24, 29, 30, 31, 29, 35, 34, 28, 28, 27, 28, 27, 33, 31]),
('Ecclesiastes', 'Eccl.', 'Ecc(?:l)?(?:\.|esiastes)', [18, 26, 22, 16, 20, 12, 29, 17, 18, 20, 10, 14]),
('Song of Songs', 'S.S.', '(?:S\.S\.)|(?:Song of Songs)', [17, 17, 11, 16, 16, 13, 13, 14]),
...
('Hosea', 'Hosea', 'Hos(?:\.|ea)', [11, 23, 5, 19, 15, 11, 16, 14, 17, 15, 12, 14, 16, 9]),
('Joel', 'Joel', 'Joel', [20, 32, 21]),
('Amos', 'Amos', 'Amos', [15, 16, 15, 13, 27, 14, 17, 14, 15]),
('Obadiah', 'Oba.', 'Oba(?:\.|diah)', [21]),
('Jonah', 'Jonah', 'Jonah', [17, 10, 10, 11]),
('Micah', 'Micah', 'Mic(?:\.|ah)', [16, 13, 12, 13, 15, 16, 20]),
('Nahum', 'Nahum', 'Nah(?:\.|um)', [15, 13, 19]),
...
('1 Corinthians', '1 Cor.', '(?:1|I|First)(?:\s*)Cor(?:\.|inthians)', [31, 16, 23, 21, 13, 20, 40, 13, 27, 33, 34, 31, 13, 40, 58, 24]),
('2 Corinthians', '2 Cor.', '(?:2|II|Second)(?:\s*)Cor(?:\.|inthians)', [24, 17, 18, 18, 21, 18, 16, 24, 15, 18, 33, 21, 14]),
...
('1 Thessalonians', '1 Thes.', '(?:1|I|First)(?:\s*)Thes(?:\.|salonians)', [10, 20, 13, 18, 28]),
('2 Thessalonians', '2 Thes.', '(?:2|II|Second)(?:\s*)Thes(?:\.|salonians)', [12, 17, 18]),
('1 Timothy', '1 Tim.', '(?:1|I|First)(?:\s*)Tim(?:\.|othy)', [20, 15, 16, 16, 25, 21]),
('2 Timothy', '2 Tim.', '(?:2|II|Second)(?:\s*)Tim(?:\.|othy)', [18, 26, 17, 22]),
('Titus', 'Titus', 'Tit(?:\.|us)', [16, 15, 15]),
('Philemon', 'Philem.', 'Phile(?:\.|mon)', [25]),
('Hebrews', 'Heb.', 'Heb(?:\.|rews)', [14, 18, 19, 16, 14, 20, 28, 13, 28, 39, 40, 29, 25]),
('James', 'James', 'Jam(?:\.|es)', [27, 26, 18, 17, 20]),
('1 Peter', '1 Pet.', '(?:1|I|First)(?:\s*)Pet(?:\.|er)', [25, 25, 22, 19, 14]),
('2 Peter', '2 Pet.', '(?:2|II|Second)(?:\s*)Pet(?:\.|er)', [21, 22, 18]),
('1 John', '1 John', '(?:(?:1|I|First)(?:\s*))John', [10, 29, 24, 21, 21]),
('2 John', '2 John', '(?:(?:2|II|Second)(?:\s*))John', [13]),
('3 John', '3 John', '(?:(?:3|III|Third)(?:\s*))John', [14]),
('Jude', 'Jude', 'Jude', [25]),
('Revelation', 'Rev.', 'Rev(?:\.|elation)', [20, 29, 22, 11, 14, 17, 17, 13, 21, 11, 19, 17, 18, 20, 8, 21, 18, 24, 21, 15, 27, 21]),
),}
